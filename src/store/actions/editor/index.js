...
export const changeEditorSettingsField = factory.create('CHANGE_EDITOR_SETTINGS_FIELD');
export const changeEditorSettingsFieldAsync = factory.createAsync('CHANGE_EDITOR_SETTINGS_FIELD_ASYNC');
